...
class prs_ssrtt_initiator_fft_zc_profiling(gr.top_block):
    ...
    def __init__(self):
        ...
        self.prs_timing_collector_0 = ofdm_prs_ranging.prs_timing_collector("CSV/profiling/initiator_fft_zc_timing_raw.csv", "CSV/profiling/initiator_fft_zc_timing_summary.csv", "initiator")
        ...
        self.prs_frame_detector_0 = ofdm_prs_ranging.prs_fft_zc_frame_detector(samp_rate, 1024, 128, 1024, 16, premble_length, premble_rep, zc_length, 1000, 1000, 0.35, 10000, 29, 1, True, 0.05, 0.0002, 0.004, 0.4, 2048, 1024, 1024, False, 1.0, True)
