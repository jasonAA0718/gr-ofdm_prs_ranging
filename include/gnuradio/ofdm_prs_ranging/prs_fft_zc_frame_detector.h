...
#ifndef INCLUDED_OFDM_PRS_RANGING_PRS_FFT_ZC_FRAME_DETECTOR_H
#define INCLUDED_OFDM_PRS_RANGING_PRS_FFT_ZC_FRAME_DETECTOR_H
...
class OFDM_PRS_RANGING_API prs_fft_zc_frame_detector : virtual public gr::block
{
public:
    typedef std::shared_ptr<prs_fft_zc_frame_detector> sptr;
...
#endif /* INCLUDED_OFDM_PRS_RANGING_PRS_FFT_ZC_FRAME_DETECTOR_H */
